            ...
            for i in range(len(lst2['xCoordinates'])):
                ...
                # Assigning the X and Y coordinate to the first position of the list
                    ...
                    if lst2['xCoordinates'][0] == 0:
                        ...
                        boxes['C']['Difference'] = pix * abs(boxes['B']['yCoordinates'] - boxes['A']['yCoordinates'])

            # Create textbox at top left with the "Difference"
            cv2.rectangle(image, (0, 0), (200, 75), (255,255,255), -1)
            cv2.putText(image, "Difference is " + str(boxes['C']['Difference']) + " um", (0, 50), cv2.QT_FONT_NORMAL, 0.5,
                        (0, 0, 0), thickness=1)
